<!-- src/NHK/SecurityBundle/Resources/views/Security/login.html.php -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="bundles/qc/assets/plugins/select2/select2.css"/>
    <link rel="stylesheet" type="text/css" href="bundles/qc/assets/plugins/select2/select2-metronic.css"/>
    ...
    <link href="bundles/qc/assets/css/pages/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
    <a href="index.html">
        <img src="bundles/qc/assets/img/logo-big.png" alt=""/>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
<!-- BEGIN LOGIN FORM -->
<form class="login-form" action="<?php echo $view['router']->generate('login_check') ?>" method="post">
    ...
    <div class="form-group">
        ...
        <div class="input-icon">
            ...
            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="_username"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="input-icon">
            ...
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="_password"/>
        </div>
    </div>
    <div class="form-actions">
        <label class="checkbox">
            <input type="checkbox" name="_remember" value="1"/> Remember me </label>
...
<script src="bundles/qc/assets/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
<script type="text/javascript" src="bundles/qc/assets/plugins/select2/select2.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="bundles/qc/assets/scripts/core/app.js" type="text/javascript"></script>
<script src="bundles/qc/assets/scripts/custom/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
